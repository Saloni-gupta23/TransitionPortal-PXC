      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in to access the SSC India transition control center.
          </p>
          <form onSubmit={submit} className="mt-8 space-y-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <a className="text-xs text-brand-deep hover:underline" href="#">
                  Forgot password?
                </a>
              </div>
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-white">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-sm opacity-90">
              Govern, monitor and report every SSC India transition — from
              strategic planning through hypercare — in one secure,
              executive-ready platform.
            </p>
            <div className="mt-10 grid max-w-md grid-cols-3 gap-4 text-xs">
              {[
                ...
                <div
                  key={l}
                  className="rounded-lg border border-white/20 bg-white/10 p-3 backdrop-blur"
                >
          ...
          <div className="text-[11px] opacity-75">
            © Phoenix Contact India · Confidential
          </div>
        </div>
      </div>
    </div>
