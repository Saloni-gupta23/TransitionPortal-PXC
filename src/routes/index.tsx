...
function Welcome() {
  ...
  useEffect(() => {
    const seen =
      typeof window !== "undefined" && sessionStorage.getItem("pc.welcomed");
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white">
      <div className="relative flex h-32 items-center justify-center">
        <span
          key={i}
          className="animate-greet bg-gradient-hero bg-clip-text text-6xl font-bold tracking-tight text-transparent md:text-8xl"
        >
          {GREETINGS[i]}
        </span>
      </div>
